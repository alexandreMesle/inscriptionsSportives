...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 26 nov. 2017 à 20:17
...
DROP PROCEDURE IF EXISTS `addMembreEquipe`$$
...
DROP PROCEDURE IF EXISTS `addPers`$$
...
DROP PROCEDURE IF EXISTS `addPersEquipe`$$
...
DROP PROCEDURE IF EXISTS `deleteCand`$$
...
DROP PROCEDURE IF EXISTS `deletePersonneEquipe`$$
...
DROP PROCEDURE IF EXISTS `InscrireCandComp`$$
...
DROP PROCEDURE IF EXISTS `modifComp`$$
...
DROP PROCEDURE IF EXISTS `modifPersonne`$$
...
DROP PROCEDURE IF EXISTS `removeCandToComp`$$
...
DROP PROCEDURE IF EXISTS `selectInscriptionCandidat`$$
...
DROP PROCEDURE IF EXISTS `suppComp`$$
...
DROP PROCEDURE IF EXISTS `suppPersonne`$$
...
DROP PROCEDURE IF EXISTS `updateCand`$$
...
DROP TABLE IF EXISTS `java_appartenir`;
CREATE TABLE IF NOT EXISTS `java_appartenir` (
  `id_equipe` int(11) NOT NULL,
  `id_personne` int(11) NOT NULL,
  PRIMARY KEY (`id_equipe`,`id_personne`),
  KEY `FK_appartenir_id_personne` (`id_personne`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `java_appartenir`
--
...
--
DROP TRIGGER IF EXISTS `before_Insert_appartenir`;
DELIMITER $$
...
DROP TABLE IF EXISTS `java_candidat`;
...
--
-- Déchargement des données de la table `java_candidat`
--
...
--
DROP TRIGGER IF EXISTS `before_Insert_candidat`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `before_Update_candidat`;
DELIMITER $$
...
DROP TABLE IF EXISTS `java_competition`;
...
--
-- Déchargement des données de la table `java_competition`
--
...
DROP TABLE IF EXISTS `java_inscription`;
CREATE TABLE IF NOT EXISTS `java_inscription` (
  `id_candidat` int(11) NOT NULL,
  `id_competition` int(11) NOT NULL,
  PRIMARY KEY (`id_candidat`,`id_competition`),
  KEY `FK_inscrire_id_competition` (`id_competition`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `java_inscription`
--
...
DROP TABLE IF EXISTS `java_personne`;
...
--
-- Déchargement des données de la table `java_personne`
--
